/* arch/arm/plat-s5p4418/jf4418/include/nxp-fb.h
 *
 * Copyright (c) 2016 PDTECH Co, LTD (www.pdtech.vn)
 *
 ...
 * Public interfaces
 */
extern int jf44182_setup_lcd_by_id(int id);
extern int jf4418_setup_lcd_by_name(char *name);
extern struct nxp_lcd *jf4418_get_lcd(void);
extern const char *jf4418_get_lcd_name(void);
extern int jf4418_get_lcd_density(void);
